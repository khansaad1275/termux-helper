...
if [[ "$user_input" == "uninstall" ]]; then
    ...
    echo "Thank you for choosing to keep Termux Helper. It's an investment in your productivity and growth."
       ...
       25)
        ...
        echo ""
        type_animation "Guys the Termux Ethical Hacking course is finally out. This is a 15-day course that will teach you Termux from basic to advance. All the important topics are covered and once you learn this course, you will never need to ask anyone for commands, so just checkout the course. Thank you ❤️"
        echo ""
     echo -n "Redirecting you to the Course in 3 " && sleep 1 && echo -ne "\b\b\b2 " && sleep 1 && echo -ne "\b\b\b1 " && sleep 1 && echo -ne "\b\b\bDone!      \n"
